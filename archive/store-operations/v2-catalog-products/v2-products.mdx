---
title: Products V2
keywords: v2, catalog, configurable_fields, products
---
# Products V2

<Callout type="warning">
  It is recommended to use the new [Catalog Products](/docs/rest-catalog).
</Callout>
...
| option_set_id | int | The ID of the [option set](/archive/store-operations/v2-catalog-products/v2-option-sets) applied to the product. (NOTE: To remove the option set from the product, set the value to `null` on update.) |
...
| rules | resource | Rules that apply only to this product, based on the product's [option set](/archive/store-operations/v2-catalog-products/v2-option-sets). See [Product Rules](/archive/store-operations/v2-catalog-products/v2-product-rules) resource for information. |
| option_set | resource | See the [Product Option Sets](/archive/store-operations/v2-catalog-products/v2-option-sets) resource for information. |
