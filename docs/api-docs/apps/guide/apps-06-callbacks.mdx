...
| `user.id` | integer | The ID of the store owner who initiates the callback. |
| `user.email` | string | The email address of the store owner who initiates the callback. |
| `user.locale` | string | The [BCP 47](https://www.rfc-editor.org/info/bcp47) language tag of the store owner who initiates the callback. |
