...
To begin the app certification process, provide the technical details of the app. Specify app type, multiple users support, callback URLs, and OAuth scopes; and, provide detailed testing instructions.
