...
```
3. Navigate to `http://localhost:4040/` in your browser. You should see the ngrok web interface. Copy the HTTPS tunnel URL and keep the app running. Your terminal should display a message similar to the following:
