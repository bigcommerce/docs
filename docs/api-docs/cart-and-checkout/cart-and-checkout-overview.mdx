...
To learn more about using the Fetch API with the REST Storefront API, see our [Working with the REST Storefront API: Cart and checkout](/docs/storefront/cart-checkout/guide/rest-storefront) tutorial.
...
```http filename="Create REST Storefront cart with variant" showLineNumbers copy
{
  "lineItems": [
    {
      "quantity": 1,
...
* [REST Storefront API: Cart and checkout](/docs/storefront/cart-checkout/guide/rest-storefront)
