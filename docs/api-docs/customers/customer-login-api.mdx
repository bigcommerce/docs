...
<Callout type="info">
You can also use the [GraphQL Storefront API](/docs/start/authenication/graphql-storefront#customer-login) to authorize your application to work with customer-specific storefront data.  
</Callout>
