# BigCommerce APIs: Best practices

## REST and GraphQL APIs

Use the following strategies listed in this document when you develop with our APIs to ensure an excellent shopping experience for your guests. Methods like keeping your integration up to date, anticipating changes to APIs, using webhooks to listen for changes, and threading API requests, can ensure superb platform stability for your clients.
