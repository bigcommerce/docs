...
| Metafield Ownership | manage | `` | Manage which API accounts own metafields. |  |
| Metafields Access | standard | `` | Default. Create and manage metafields belonging to the API account making the request. | All endpoints and APIs that manage metafields. |
| Metafields Access | full | `` | Create and manage all metafields for the store, regardless of the API account that created them. Includes AppOnly metafields. | All endpoints and APIs that manage metafields. |
