...
This end-to-end guide demonstrates how to power headless storefronts. These steps will allow you to build shopping experiences where the purchase funnel is largely powered by GraphQL, from catalog browsing through checkout. The examples walk you through critical GraphQL capabilities to fit most use cases when creating a headless storefront:
...
<Tabs items={['Request', 'Response']}>
  <Tab>
    ...
    fragment CheckoutAddressFields on CheckoutAddress {
      ...
      postalCode
      phone
      customFields(entityId: $entityId) {
        entityId
    ...
    fragment CheckoutShippingConsignmentFields on CheckoutShippingConsignment(entityId: $entityId)  {
      entityId
      address {
    ...
    fragment CheckoutAvailableShippingOptionFields on CheckoutAvailableShippingOption(entityId: $entityId) {
      entityId
      description
      type
      imageUrl
    ...
    fragment CheckoutSelectedShippingOptionFields on CheckoutSelectedShippingOption(entityId: $entityId) {
      entityId
      description
      type
      imageUrl
    ...
    fragment CheckoutCouponFields on CheckoutCoupon(entityId: $entityId) {
      entityId
      code
      couponType
      discountedAmount {
...
mutation addCheckoutShippingConsignments($addCheckoutShippingConsignmentsInput: AddCheckoutShippingConsignmentsInput!) {
  checkout {
    addCheckoutShippingConsignments(input: $addCheckoutShippingConsignmentsInput) {
      checkout(entityId: $entityId) {
        entityId
        shippingConsignments(entityId: $entityId) {
          entityId
          availableShippingOptions(entityId: $entityId) {
            entityId
          }
          selectedShippingOption(entityId: $entityId) {
            entityId
          }
        }
      }
