...
<Callout type="info">
* While the server-side API clients can use either a Storefront API token or a customer impersonation token, client-side web browsers cannot use customer impersonation tokens.
