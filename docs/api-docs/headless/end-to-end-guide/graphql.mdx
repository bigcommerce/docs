...
* Note that you would not usually use a customer impersonation token in the GraphQL Storefront Playground. The use of the GraphQL Storefront Playground and customer impersonation token are solely for this tutorial.
