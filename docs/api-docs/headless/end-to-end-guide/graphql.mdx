...
<Callout type="info">
You can use the GraphQL Storefront Playground to perform the example queries presented in this guide. To access the GraphQL Storefront API Playground and documentation, [sign in to your store](https://login.bigcommerce.com/login), and navigate to **Settings** > **API** > **Storefront API Playground**.
</Callout>
