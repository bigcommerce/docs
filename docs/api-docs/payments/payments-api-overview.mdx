...
Consult the [Create Payment Access Token](/docs/rest-payments) endpoint to use the OAuth permission scope for your application's [API Account](/docs/start/authentication/api-accounts).
