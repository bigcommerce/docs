...
| storefront API customer impersination tokens | modify | `store_storefront_api_customer_impersonation` | Create GraphQL storefront API bearer tokens that allow customer impersonation |
