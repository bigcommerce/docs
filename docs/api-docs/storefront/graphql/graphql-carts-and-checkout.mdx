...
<Callout type="info">
You can use a cart redirect URL for embedded checkouts or to redirect your checkout. A cartEntity ID is required. To create a cartEntity ID, use the [create a cart](#Create-a-cart-using-a-simple-product) mutation. 
</Callout>
