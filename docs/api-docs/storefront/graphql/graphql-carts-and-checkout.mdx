...
* [GraphQL Storefront API Overview: Using auto-generated tokens in Stencil themes](/docs/start/authentication/graphql-storefront#using-auto-generated-tokens-in-stencil-themes)
