...
Then download and install the latest supported version of [ngrok](http://ngrok.com/download/). 
...
<Callout type="info">
  ...
  * For simplicity, this tutorial uses an [npm package](https://www.npmjs.com/package/ngrok) to run ngrok. For official ngrok usage and installation instructions, visit [ngrok.com](https://ngrok.com/).
</Callout>

The following commands show the steps to install ngrok using Homebrew.
