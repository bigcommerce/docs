...
| Name / Scope             | Description |
|:-------------------------|:------------|
| store/option/updated | Fires when you edit attributes for a local or shared variant option. Updates to the global store and channel locale as an override triggers the webhook. The `context` fields are present for only override updates. |
...
| store/sku/updated | Fires when you edit a variant globally or for a channel locale as an override. The `context` fields are present for only override updates. |
...
```json filename="Example sku updated payload object" showLineNumbers copy
{
...
| Name / Scope             | Description |
|:-------------------------|:------------|
| store/url-path/updated | Fires when you edit a product or variant's URL path globally or for a channel locale as an override. The `context` fields are present for only override updates. |
