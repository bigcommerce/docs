...
| store/order/created | Fires when an order is created from the storefront, using the control panel, an app, or the API. This action includes: incomplete, failed payment, and payment not processed orders. |
