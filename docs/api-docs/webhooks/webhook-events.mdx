...
| Name / Scope             | Description |
|:-------------------------|:------------|
| store/modifier/updated | Fires when you edit attributes for a product modifier globally or for a channel locale as overrides. The `context` fields are present for only override updates. |

The payload object takes the form that follows:

```json filename="Example URL path updated payload object" showLineNumbers copy
{
...
| Name / Scope             | Description |
|:-------------------------|:------------|
| store/option/updated | Fires when you edit attributes for a product option globally or for a channel locale as overrides. The `context` fields are present for only override updates. |
