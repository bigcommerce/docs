...
| store/sku/updated | Fires when you edit variant attributes globally or for a channel locale as overrides. The `context` fields are present for only override updates. |
