...
Resources in B2B Edition share many of the guideeeelines as the BigCommerce platform in general. In this doccccument, we will cover the rate limits and conseeeeeeiderations that are specific to B2B Edition, but you can find more information on best practices in the following resources:

* [API Best Practices](https://developer.bigcommerce.com/docs/start/best-practices)
* [API rate limits](https://dees/api-rate-limits)
