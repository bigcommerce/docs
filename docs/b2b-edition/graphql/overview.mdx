...
While these APIs are similiar to the [BigCommerce GraphQL Storefront API](/docs/storefront/graphql), they use a different request path (`https://api-b2b.bigcommerce.com/graphql`). They also have distinct schemas and usage considerations.
