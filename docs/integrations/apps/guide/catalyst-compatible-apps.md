...
If you have an existing app or integration in the BigCommerce App Marketplace that you offer for existing BigCommerce stores, it is possible that you will need to fork your app and make it Catalyst-compatible, or update your integration to support Catalyst.
...
- Prioritize integrations that enhance the shopper experience, as these have the greatest impact on site performance and usability.
...
### I integrate with BigCommerce checkout only
...
## Leverage the BigCommerce developer ecosystem

- Join the BigCommerce Developers Slack to collaborate and share ideas.  
- Align with Catalyst’s roadmap through community engagement.  
- Write about your integration experience for the Resource Hub and the monthly developer newsletter.  
