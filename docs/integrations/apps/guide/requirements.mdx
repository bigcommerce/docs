...
* Apps that are MLI-compatible must use the [Inventory API](/docs/store-operations/catalog/inventory-adjustments), not the [Catalog API](/docs/rest-catalog), to adjust inventory in a store.
