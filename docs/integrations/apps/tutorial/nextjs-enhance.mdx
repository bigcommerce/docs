...
[BigDesign](https://developer.bigcommerce.com/bigdesign) plays a pivotal part in the BigCommerce control panel and ecosystem. App developers are encouraged to use BigDesign to develop apps that have a native BigCommerce look and feel.
