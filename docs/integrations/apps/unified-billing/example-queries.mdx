...
#### Field Descriptions
| Field | Description | Trial Behavior
|:--------|:-----------|:-----------|
...
| productLevel (product) | The level of your product | |
...
| currencyCode (price) | The currency in which the merchant will be charged | |
| trialDays (pricingPlan) | The number of trial days granted to the merchant | The merchant will not be invoiced until the trial days are over. | |
...
| description | A description for your app | |
| redirectUrl | The URL the merchant will be redirected to after completing the checkout. | |
| subscriptionId | The id of the subcription that was returned after a fetch of a completed checkout | |
