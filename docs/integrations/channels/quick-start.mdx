...
Apps curated as solutions within the **Create Channel** flow must create a basic channel with a reference to their BigCommerce [App ID](/docs/integrations/apps/guide/id). This enables them to be shown in the [Channel Manager](/docs/integrations/channels) as managing a specific channel; it also improves the native look and feel for the merchant using the app. To make changes to UI sections, use the [Create a channel menu](/docs/rest-management/channels/channel-menus#create-channel-menus) endpoint.
