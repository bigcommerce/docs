...
Once you've obtained your app ID, complete the form [here](https://docs.google.com/forms/d/e/1FAIpQLScyKcSDuxwVReLbSuXqrJCcWMnuX7b-SGNF0ZIXGEEAabfXng/viewform?usp=header) using the information below as a reference. We can then create your tax provider configuration, which will take approximately five days.
