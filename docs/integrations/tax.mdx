...
Once you've obtained your app ID, share your app ID and the information below with BigCommerce by filling out [this form](https://docs.google.com/forms/d/e/1FAIpQLScyKcSDuxwVReLbSuXqrJCcWMnuX7b-SGNF0ZIXGEEAabfXng/viewform?usp=header). This information allows us to create your tax provider configuration, which will take approximately five days.
