...
| Name / Scope            | Description |
|:------------------------|:------------|
| store/quote/created | Fires when a new sales quote is created from the Buyer Portal, the B2B Edition control panel, or via the Server to Server API. This webhook will not fire when a buyer creates a [draft quote](/b2b-edition/apis/rest-storefront/request-for-quote/quotes#draft-quotes) from the Buyer Portal. |
