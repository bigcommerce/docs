...
|:------------------------|:------------|
| store/company/* | Fires for all store/company events. This includes [Company User](#company-users) and [Company Address](#company-address) events. |
...
| Name / Scope            | Description |
|:------------------------|:------------|
| store/superadmin/* | Fires for all store/superadminevents. |
