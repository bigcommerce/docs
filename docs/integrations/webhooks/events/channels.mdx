...
| `store/channel/{channel_id}/settings/locale/added`    | Fires when a channel locale is added to any channel.| [Adding a locale]() |
| `store/channel/{channel_id}/settings/locale/updated`    | Fires when a channel locale is updated to any channel.| [Updating a locale ()] |
| `store/channel/{channel_id}/settings/locale/deleted`    | Fires when a channel locale is deleted to any channel.| [Deleting a locale() |
...
| `store/channel/{channel_id}/settings/customerPrivacy/updated` | Fires when customer privacy settings that affect the specified channel are updated. | [Update customer settings per channel](/docs/rest-management/customers/channel-settings#update-customer-settings-per-channel) |
