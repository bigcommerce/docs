...
| store/product/customField/updated |  Fires when you update a custom field for a product globally or for a channel locale as an override. The `context` fields are present for only override updates. |
