...
The following variables are available within printable packing slip template:
...
The following variables are for use in HTML elements for altering CSS styling.

<Callout type="info">
The "Hide" variables are all used to selectively hide HTML elements depending on whether the content they have under them is available.
</Callout>
