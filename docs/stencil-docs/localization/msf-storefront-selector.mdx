...
This guide walks you through how to add data for the storefront selector into your theme.
...
- Step 2: Install the necessary project dependencies.
...
To upload the bundle with the updated selector, go to Themes in the control panel and click the Upload Theme button. Select the bundle created in the previous step and upload it. For more information, see the [Stencil Themes - Downloading and Uploading Custom Themes](https://support.bigcommerce.com/s/article/Stencil-Themes?language=en_US#download-upload) support article.
