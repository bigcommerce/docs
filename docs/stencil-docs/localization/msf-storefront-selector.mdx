...
To localize shopping experiences, you can have [multiple storefronts](/docs/storefront/multi-storefront) that target specific shopper segments, regions, or brands. You can add a selector to a theme so that shoppers can select the storefront they want to browse from a list of options.
