...
You can use front matter to specify attributes on the tops of pages in your `templates/pages` subdirectory (e.g., `templates/pages/brand.html`). Front matter is prohibited within the subdirectory (e.g., `templates/pages/custom`).
