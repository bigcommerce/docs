...
By default, product images are visible on all storefront channels and locales. To change product visibility, see [Image visibility](#image-visibility).

You can change the details of an image that you have added to a product: 
- [Set product image information](#set-product-image-information) for the catalog. You can set global values and overrides for the image information in a channel locale.
