...
To get an understanding of the scale of your catalog and its current contents, the [Get a Catalog Summary](/docs/rest-catalog/products/summary) endpoint is provided as part of the Catalog API. It provides general information on current inventory count, total products and variants, price ranges, and basic category data.
