...
Add [shipping addresses](/docs/rest-management/orders/order-shipping-addresses#update-a-shipping-address) by including a [shipping_address array](/docs/rest-management/orders/order-shipping-addresses#update-a-shipping-address) in the [create order](/docs/rest-management/orders#create-an-order) request.
