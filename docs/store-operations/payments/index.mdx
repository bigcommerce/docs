...
![enable-stripe-ocs-ach](https://storage.googleapis.com/bigcommerce-production-dev-center/images/stripe-ocs-ach.png)
...
You can find an example Checkout JS SDK implementation of Stripe OCS ACH in the [checkout-js repository](https://github.com/bigcommerce/checkout-js/tree/master/packages/stripe-integration/src/stripe-ocs).
