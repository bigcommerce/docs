...
Customer segments provide greater flexibility. They leverage both the permanent and transient characteristics of a shopper to drive highly personalized shopping experiences. A [shopper profile](/docs/store-operations/segments/definitions#shopper-profile) can belong to multiple segments.
...
### Endpoints
* [Customer Segmentation V3 API Reference](/docs/rest-management/segments)
