...
<Callout type="info"> 
 The Customer Segmentation API supports the following capabilities:
...
A **customer segment** is a collection of shoppers that share specific characteristics. Segmentation defines groups of shoppers that a merchant wants to target with a [Promotion](/docs/store-operations/segments/promotions), or dedicated value proposition.
