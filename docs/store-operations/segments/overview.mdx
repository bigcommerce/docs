...
<Callout>
  ...
  * Add a shopper to multiple segments - shoppers, or registered customers, can belong to up to 1000 segments, meaning you can target a registered customer with multiple promotional experiences.
