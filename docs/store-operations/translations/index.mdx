...
## Resources
* [Translations for Categories (Beta)](/docs/store-operations/translations/categories.mdx)
* [Translations for Locations (Beta)](/docs/store-operations/translations/locations.mdx)
