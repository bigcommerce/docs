...
## Overview
The Translations Admin GraphQL API is currently available on Catalyst storefronts only. It enables merchants to translate a single website into multiple languages. 
