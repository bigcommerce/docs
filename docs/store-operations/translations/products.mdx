---
title: Translations for Products
sidebar_position: 5
keywords: translations, products, localization, i18n, graphql
description: Translate product information for multilingual storefronts using the Translations Admin GraphQL API.
---
...
For translations of product Custom Fields and Product Options, see:
- [Custom Fields Translations](/docs/store-operations/translations/custom-fields)
- [Product Options Translations](/docs/store-operations/translations/options)

## Resource fields

Products are referenced using the following values in the queries outlined below:

| Entity Type | `resourceType` | `resourceId` Format |
| --- | --- | --- |
| Product | `PRODUCTS` | `bc/store/product/{{product_id}}` |

For Custom Fields and Product Options resource fields, see:
- [Custom Fields Resource Fields](/docs/store-operations/translations/custom-fields#resource-fields)
- [Product Options Resource Fields](/docs/store-operations/translations/options#resource-fields)
