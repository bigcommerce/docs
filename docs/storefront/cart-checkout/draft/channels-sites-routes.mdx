...
* Catalog: Price Lists ([API docs](/api-docs/catalog/price-list-overview), [API reference](/docs/rest-management/price-lists))
* Store Management: Shipping ([API docs](/api-docs/store-management/shipping/shipping-overview), [API reference](/docs/rest-management/shipping-v2)) 
...
* Customers & Subscribers: Customers ([API docs](/api-docs/customers/customers-subscribers-overview), [v2 API reference](/docs/rest-management/customers-v2), [v3 API Reference](/docs/rest-management/customers), [webhooks](/api-docs/store-management/webhooks/webhook-events#customer))
* Cart & Checkout: Server to Server Cart ([API Docs](/api-docs/storefront/cart-and-checkout-overview), [API Reference](/docs/rest-management/carts))
* Cart & Checkout: Server to Server Checkout ([API Docs](/api-docs/storefront/cart-and-checkout-overview), [API Reference](/docs/rest-storefront/checkouts))
...
| Required to use BigCommerce’s BigDesign  UI components | Yes | No|
...
In order to make an app feel and look native to BigCommerce, our BigDesign UI components must be used, as they conform to our design and style guidelines. Any app that is in the channel manager must use these in order to maintain consistency with the BigCommerce control panel.
