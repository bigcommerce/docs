...
In order to make an app feel and look native to BigCommerce, our [BigDesign UI components](https://developer.bigcommerce.com/big-design) must be used, as they conform to our design and style guidelines. Any app that is in the channel manager must use these in order to maintain consistency with the BigCommerce control panel.
