...
To load the payment method configuration and initialize the Fastlane SDK for use across the entire checkout page, call `checkoutService.initializeCustomer` whe a shopper opens the customer step.
