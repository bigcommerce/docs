...
For information on how to manage translations for the storefront theme, see the [Theme Translations](/docs/storefront/catalyst/content-management/internationalization/theme-translations) guide.
...
* Add translations for products to multiple locales added to Catalyst channel. Learn about how to use the GraphQL Admin API to [add translations to a single channel and locale](https://developer.bigcommerce.com/docs/store-operations/catalog/msf-international-enhancements) or use BigCommerce's [Translations UI App](https://support.bigcommerce.com/s/article/The-BigCommerce-Translations-App).
...
* Add translations for categories and locations to multiple locales added to Catalyst channel. Learn about how to use the [GraphQL Admin API](https://developer.bigcommerce.com/docs/store-operations/translations) to add translations to a single channel and locale or use BigCommerce's [Translations UI App](https://support.bigcommerce.com/s/article/The-BigCommerce-Translations-App).
