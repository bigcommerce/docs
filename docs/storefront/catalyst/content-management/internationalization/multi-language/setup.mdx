...
<Callout type="info">
  **Control Panel access:** The Localization tab in Channels for adding/removing locales is available for Catalyst channels in **Settings** > **Localization** or via editing the channel in **Channels**.
