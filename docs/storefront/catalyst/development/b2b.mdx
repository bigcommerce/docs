...
### B2B Edition login page settings

This reference implementation does not support any configuration made in this [B2B Edition setting](https://support.bigcommerce.com/s/article/B2B-Edition-Settings?language=en_US#login). 
