...
<Callout type="info">
**Catalyst v1.2 and later**: Route caching now uses Vercel Runtime Cache automatically when deployed on Vercel, providing optimal performance without requiring external KV storage setup. See [Middleware](/docs/storefront/catalyst/development/middleware) for more details.
</Callout>
