...
Learn how to create your Catalyst storefront using [One-Click Catalyst](https://www.catalyst.dev/workflows/one-click-catalyst). Alternatively, you can follow our [Manual installation guide](https://www.catalyst.dev/installation).
...
<Callout type="warning">
  ...
  Git tags. See our [how we use tags](https://www.catalyst.dev/versioning#how-we-use-tags) documentation
  for more details.
</Callout>
...
Running locally to do custom development is not required but it does enable full customization and control over your storefront. If you're interested in this, you can follow our [Local development](https://www.catalyst.dev/docs/local-development) documentation to get started.

If you're not interested in doing any custom development and are happy with what's provided out of the box, you can go directly to our [Deploying](https://www.catalyst.dev/docs/deployment) guide for next steps.
