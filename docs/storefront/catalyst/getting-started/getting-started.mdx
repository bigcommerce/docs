...
Learn how to create your Catalyst storefront using [One-Click Catalyst](/docs/storefront/catalyst/getting-started/workflows/one-click-catalyst). To create a channel without One-Click using the CLI and set up routes and Makeswift yourself, see [Create a Catalyst channel without One-Click](/docs/storefront/catalyst/getting-started/workflows/create-catalyst-without-one-click). Alternatively, you can follow our [Manual installation guide](/docs/storefront/catalyst/development/manual-installation).
