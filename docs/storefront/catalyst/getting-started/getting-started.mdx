...
Learn how to create your Catalyst storefront using [One-Click Catalyst](/docs/storefront/catalyst/getting-started/workflows/one-click-catalyst). To create a channel without One-Click using the CLI and set up routes and Makeswift yourself, see [Manually create a Catalyst channel](/docs/storefront/catalyst/getting-started/workflows/manually-create-catalyst-channel). Alternatively, you can follow our [Manual installation guide](/docs/storefront/catalyst/development/manual-installation) to create a channel using the REST Management API.
