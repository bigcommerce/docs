...
This guide assumes you used the [One-Click Catalyst](/docs/storefront/catalyst/getting-started/workflows/one-click-catalyst) workflow by following the [Getting Started](/docs/storefront/catalyst/getting-started) guide. If not, see [Create a Catalyst channel without One-Click](/docs/storefront/catalyst/getting-started/workflows/create-catalyst-without-one-click) or the [Manual installation](/docs/storefront/catalyst/development/manual-installation) docs.
