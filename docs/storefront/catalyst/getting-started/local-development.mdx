...
This guide assumes you used the [One-Click Catalyst](/docs/storefront/catalyst/getting-started/workflows/one-click-catalyst) workflow by following the [Getting Started](/docs/storefront/catalyst/getting-started) guide. If not, see [Manually create a Catalyst channel](/docs/storefront/catalyst/getting-started/workflows/manually-create-catalyst-channel) or the [Manual installation](/docs/storefront/catalyst/development/manual-installation) docs.
