...
For more details on setting up a storefront using One-Click Catalyst you can refer to our [Getting Started](/docs/storefront/catalyst/getting-started) documentation. To create a Catalyst channel without One-Click (using the REST Management API), see [Manually create a Catalyst channel](/docs/storefront/catalyst/getting-started/workflows/manually-create-catalyst-channel).
