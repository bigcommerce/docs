...
For more details on setting up a storefront using One-Click Catalyst you can refer to our [Getting Started](/docs/storefront/catalyst/getting-started) documentation. To create a Catalyst channel without One-Click (using the CLI, routes API, and optional Makeswift setup), see [Create a Catalyst channel without One-Click](/docs/storefront/catalyst/getting-started/workflows/create-catalyst-without-one-click).

Additionally, here are a few more documents that might be helpful.
