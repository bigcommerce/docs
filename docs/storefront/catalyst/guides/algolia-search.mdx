...
Follow our [Getting Started](https://www.catalyst.dev/getting-started) guide and then our [local development](https://www.catalyst.dev/Local-development) documentation to ensure you're able to run your Catalyst application locally.
