...
If you want more details on the `<Script/>` component we use in this guide, check out our [Manually installing scripts](https://www.catalyst.dev/docs/guides/manually-installing-scripts) guide.
