...
If you want to see a real-world example of an app's script being added to Catalyst, check out the [Adding Mailchimp to Catalyst](https://www.catalyst.dev/docs/guides/mailchimp-newsletter) guide.
