...
[![Catalyst for Composable Commerce Image Banner](https://storage.googleapis.com/bigcommerce-developers/images/catalyst_readme_banner.png)](https://catalyst.dev)
...
* **A caching backend**. For example, using Vercel KV may improve the performance of our [with-routes middleware](https://www.catalyst.dev/docs/catalyst-middleware.md).
...
* **Evaluating middleware**. Assess the costs and benefits of the [default Catalyst middleware](https://www.catalyst.dev/docs/catalyst-middleware.md). You may tailor the middleware for your use case or remove it altogether.
