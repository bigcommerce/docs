...
* **Optimized caching performance**. 
  * Using an external KV storage solution is recommended for optimal performance of our [with-routes middleware](/docs/storefront/catalyst/development/middleware.md).
...
* [🤖 Catalyst AI Documentation](https://deepwiki.com/bigcommerce/catalyst) - Ask questions and find up-to-date architectural information
