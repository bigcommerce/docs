...
<img
	src='https://storage.googleapis.com/bigcommerce-production-dev-center/images/catalyst/reference/consent-manager.png'
	alt='Consent Banner'
...
<img
	src='https://storage.googleapis.com/bigcommerce-production-dev-center/images/catalyst/release-notes/gift-certificates-2.png'
	alt='Gift Certificates'
	className='rounded-xl'
/>
<p className='text-center text-sm italic px-10 md:px-20 mt-2'>
	Enabling shoppers to purchase gift certificates (respecting merchant-defined
	configurations such as fixed vs. variable amounts, expiration durations, and
	available templates)
</p>
...
<img
	src='https://storage.googleapis.com/bigcommerce-production-dev-center/images/catalyst/release-notes/gift-certificate-preview.png'
	alt='Gift Certificate Preview'
	className='rounded-xl'
/>
<p className='text-center text-sm italic px-10 md:px-20 mt-2'>
...
<img
	src='https://storage.googleapis.com/bigcommerce-production-dev-center/images/catalyst/release-notes/gift-certificate-redemption.png'
	alt='Gift Certificate Redemption'
	className='rounded-xl'
/>
<p className='text-center text-sm italic px-10 md:px-20 mt-2'>
...
<img
	src='https://storage.googleapis.com/bigcommerce-production-dev-center/images/catalyst/release-notes/gift-certificate-balance.png'
	alt='Gift Certificate Balance'
	className='rounded-xl'
/>
<p className='text-center text-sm italic px-10 md:px-20 mt-2'>
