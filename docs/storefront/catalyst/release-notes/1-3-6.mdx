...
Catalyst v1.3.6 release addresses a **critical security vulnerability ([CVE-2025-55184, CVE-2025-55183](https://react.dev/blog/2025/12/11/denial-of-service-and-source-code-exposure-in-react-server-components))** that affects React Server Components.

## Key Changes

- **Next.js 15.5.7**: Upgraded from Next.js 15.5.7 to 15.5.8
