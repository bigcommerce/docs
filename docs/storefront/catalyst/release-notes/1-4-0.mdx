...
Catalyst has been upgraded to Next.js 16, bringing improved performance, new features, and better developer experience. This upgrade requires [migration steps](#migration-guide) for existing stores.
