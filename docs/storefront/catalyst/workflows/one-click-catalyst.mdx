...
<Callout type="warning" emoji="⚠️">
  ...
  [deploying](https://www.catalyst.dev/deployment) documentation to take your storefront to production.
</Callout>
...
For more details on setting up a storefront using One-Click Catalyst you can refer to our [Getting Started](https://www.catalyst.dev/getting-started) documentation. Additionally, here are a few more documents that might be helpful.

<Cards>
  <Cards.Card title="How to Developer Locally" href="https://www.catalyst.dev/local-development" />
  <Cards.Card title="Versioning in Catalyst" href="https://www.catalyst.dev/versioning" />
  <Cards.Card title="How to Deploy Catalyst" href="https://www.catalyst.dev/deployment" />
</Cards>
