...
<a href="https://developer.bigcommerce.com/graphql-storefront/playground?tabs=customerDetails" target="_blank">**Try it in GraphQL Playground**</a>
...
<a href="https://developer.bigcommerce.com/graphql-storefront/playground?tabs=categoryTree" target="_blank">**Try it in GraphQL Playground**</a>
...
<a href="https://developer.bigcommerce.com/graphql-storefront/playground?tabs=categoriesByUrl" target="_blank">**Try it in GraphQL Playground**</a>
...
<a href="https://developer.bigcommerce.com/graphql-storefront/playground?tabs=objectsByUrl" target="_blank">**Try it in GraphQL Playground**</a>
...
<a href="https://developer.bigcommerce.com/graphql-storefront/playground?tabs=popularBrands" target="_blank">**Try it in GraphQL Playground**</a>

## Add a favicon to Storefront GraphQL

```graphql filename="Example query: Add a favicon" showLineNumbers copy
query Favicon {
  site {
    settings {
      faviconUrl
...
<a href="https://developer.bigcommerce.com/graphql-storefront/playground?tabs=favicon" target="_blank">**Try it in GraphQL Playground**</a>
