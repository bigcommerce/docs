...
Query the product videos and all configurable media types for products. The API returns images uploaded in the control panel, image URLs added to a product using the control panel, and video URLs linked to a product. 

The following example retrieves video titles and URLs associated with videos attached to a product. 

<Callout type="info">
Before performing this example, you must ensure to add videos to the product node.
</Callout>
...
```graphql filename="Example query: Get product videos for a product" showLineNumbers copy
  query {
    site {
      products (entityId: [112, 113, 114, 115]) {
        pageInfo {
            startCursor
            endCursor
        }
                                ...
                                "edges": [
                                    {
                                        ...
                                        "node": {
                                            ...
                                            "url": "https://www.youtube.com/watch?v=Q-paU_bIvIs"
                                        }
                                    }
                                ]
                            }
                                ...
                                "edges": [
                                    {
                                        "cursor": "YXJyYXljb25uZWN0aW9uOjA=",
                                        "node": {
                                            "title": "Weekend Update ft. Kenan Thompson, Marcello Hernández and Season 49 Finale Joke Swap - SNL",
                                            "url": "https://www.youtube.com/watch?v=IPnHneSH1sg"
                                        }
                                    }
                                ]
                            }
                        ...
                        "node": {
                            ...
                            "productOptions": {
                                "edges": [
                                    ...
                                    {
                                        "node": {
                                            "displayName": "Text Field Example"
                                        }
                                    }
                                ]
                            },
                                ...
                                "edges": [
                                    {
                                        ...
                                        "node": {
                                            ...
                                            "url": "https://www.youtube.com/watch?v=86qKgK0asGo"
                                        }
                                    },
                                    {
                                        "cursor": "YXJyYXljb25uZWN0aW9uOjE=",
                                        "node": {
                                            "title": "Mr. Garvey Is Your Substitute Teacher - Key & Peele",
                                            "url": "https://www.youtube.com/watch?v=OQaLic5SE_I"
                                        }
                                    },
                                    {
                                        "cursor": "YXJyYXljb25uZWN0aW9uOjI=",
                                        "node": {
                                            ...
                                            "url": "https://www.youtube.com/watch?v=Cuf29fvlfb0"
                                        }
                                    }
                                ]
                            }
