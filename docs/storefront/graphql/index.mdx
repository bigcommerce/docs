...
## Concurrent complexity limits

For more information about how the platform protects against over-consumption and how to handle 429 responses, see [Storefront GraphQL platform protection](/docs/storefront/graphql/limiter).
...
### Documentation
* [Storefront GraphQL platform protection](/docs/storefront/graphql/limiter)
