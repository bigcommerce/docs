...
keywords: graphql, storefront, limiter
---
...
A. We have basically 3 types of clients:
...
B. Since amount of traffic is huge, you should be careful with the number of queries
you are sending, and try to optimize them as much as possible.

C. We have a limiter in place to protect our infrastructure,
and if you exceed the limits, you will get HTTP 429 errors.
...
the state of the limiter, and you can use them to optimize your implementation.
    ...
    - `X-BC-IP-Rate-Limit-Requests-Quota`: <numeric value>
    - `X-BC-IP-Rate-Limit-Requests-Quota-Left`: <numeric value>
