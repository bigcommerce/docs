...
<script>
	...
	{{jsContext}}
	outputs the string {"myProductName": "Sample Product"} console.log(jsContext);
	//type: object console.log(jsContext.myProductName) // Will output: Sample
	Product
</script>
```
...
<Callout type='info'>
	#### Good score The optimal LCP score is 2.5 seconds or faster.
</Callout>
...
<Callout type='info'>
	#### Good score The optimal CLS score is 0.1 seconds or less.
</Callout>
