...
If you are using a Cornerstone theme as your base theme, update notifications are found in our [changelog](/release-notes). If you are using another theme, please see the theme creator for updates.
