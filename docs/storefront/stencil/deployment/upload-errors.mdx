...
| TR-1002 | Your theme could not be added because schema.json was not in the correct format. |
| TR-1003 | Your theme could not be added because schema.json config was not in the correct format. |
| TR-1004 | Your theme could not be added because schema.json config settings was not in the correct format. |
| TR-1005 | Your theme could not be added because schema.json config settings element was not in the correct format. |
| TR-1006 | Your theme could not be added because schema.json exceeds the size limit. Please reduce the size of your schema.json file. |
