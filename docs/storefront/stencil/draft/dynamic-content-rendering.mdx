...
![Dropzone that places an image gallery at the bottom of a category page](https://storage.googleapis.com/bigcommerce-production-dev-center/images/stencil-storefronts-dropzone.png "Dropzone that places an image gallery at the bottom of a category page")
...
![right by you](https://storage.googleapis.com/bigcommerce-production-dev-center/images/right_by_you.png)
...
![goruck](https://storage.googleapis.com/bigcommerce-production-dev-center/images/goruck.png)
