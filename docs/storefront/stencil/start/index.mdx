...
As the default theme on new stores, Cornerstone is typically the first theme to support new theme-related features and improvements. See the [BigCommerce Developer Changelog](/release-notes) for the latest Cornerstone news and release notes.
...
All stencil themes utilizes the [Speculation Rules API](https://developer.mozilla.org/en-US/docs/Web/API/Speculation_Rules_API) to pre-render checkout pages, improving performance and user experience.
...
<Callout type="info">
  If you are hosting your own analytics you'll need to make changes to your implementation to ensure compatibility.  See [analytics documentation](https://developer.bigcommerce.com/docs/integrations/hosted-analytics) for more information.
</Callout>

## Blueprint (Legacy framework)


For information on Blueprint, BigCommerce's legacy theme framework, see [Blueprint Themes](https://support.bigcommerce.com/s/article/Blueprint-Themes?language=en_US).
...
* [Personalizing Your Theme](https://support.bigcommerce.com/s/article/Stencil-Themes?language=en_US) (BigCommerce Knowledge Base)
