...
| [getImageSrcset1x2x](#getimagesrcset1x2x) | images | Returns single image URL or list of URLs for different sizes. The 1x and 2x designations indicate the ratio of device pixels to the intended image CSS pixels. |
