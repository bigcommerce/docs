...
Stencil supports handlebar partial blocks to help you create reusable templates with dynamic content. You can define a partial block using the following syntax:
