...
To download a snapshot of a single page's regions, layouts, dropzones, and widgets, use the [Get a page snapshot](/docs/rest-content/page-widgets#get-a-page-snapshot) endpoint.
